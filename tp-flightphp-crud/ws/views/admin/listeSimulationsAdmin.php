<div class="simulation-list">
    <h1>Simulations de prêt (Admin)</h1>
    <form id="compareSimulationsForm" action="<?= BASE_URL ?>/admin/simulations/compare" method="POST">
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach ($simulations as $simulation): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($simulation['client_nom'] ?? 'N/A') ?></td>
