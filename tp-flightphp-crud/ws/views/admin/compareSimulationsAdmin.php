<div class="comparison-container">
    <h1>Comparaison des simulations (Admin)</h1>
    <?php if (isset($error)): ?>
    ...
    <?php else: ?>
                ...
                <div class="simulation-column">
                    ...
                    <div class="simulation-details">
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?= htmlspecialchars($simulation['client_nom'] ?? 'N/A') ?></span>
                        </div>
                        <div class="detail-item">
        ...
        <div class="comparison-actions">
            <a href="<?= BASE_URL ?>/admin/prets/simulations" class="btn-primary">
